...
public enum ErrorType {
    ...
    LEAVE_NOT_FOUND(1010, "Leave not found", INTERNAL_SERVER_ERROR),
    LEAVE_NOT_CREATED(1011, "Leave could not be saved", INTERNAL_SERVER_ERROR),
    LEAVE_NOT_UPDATED(1012, "Leave information could not be updated.", INTERNAL_SERVER_ERROR);
